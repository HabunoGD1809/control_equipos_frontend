         ...
         <DialogContent className="sm:max-w-md">
            <DialogHeader>
               ...
               <DialogDescription className="pt-2">
                  ¿Confirma la entrega física del equipo{" "}
                  <strong className="text-foreground">{reserva?.equipo.nombre}</strong> al usuario{" "}
                  <strong className="text-foreground">{reserva?.solicitante.nombre_usuario}</strong>?
                  <br /><br />
